...
const ResponseBody = ({ newCode }: { newCode: JsonCode | string }) => {
  return (
    <div className="max-w-[550px] w-full border-none rounded-xl h-[200px] bg-slate-900 overflow-x-auto">
      ...
      <SyntaxHighlighter language="json" style={materialDark} className="w-full h-full">
